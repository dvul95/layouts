  ...
  return (
    <div className="App">
     ...
     <div className="paragraph"><p>Lorem ipsum here. Lorem ipsum here. This is a text paragraph.This is a text paragraph lorem ipsum paragraph lorem ipsum.</p><br/></div> 
      ...
      <div className="item" style={{width:"100%", margin:"25px 0 25px 0"}}><h3>WELL, MARTY, I WANT TO THANK YOU </h3><br/><p>What? Marty, one rejection isn't the end of the world. Time machine, I haven't invented any time machine. She's just trying to keep you respectable. Yes, yes, I'm George, George McFly, and I'm your density. I mean, I'm your destiny.</p></div>
